...
As per the previous discussion, the following snipped emulates one time-step
iteration:
...
Time integration is now just a matter of repeating time-stepping and storing
solution:
