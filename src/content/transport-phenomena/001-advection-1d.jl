...
# ╔═╡ 16235e40-b344-49d2-aad0-695aca547cec
abstract type AbstractAdvection end

# ╔═╡ 3048bb97-729d-43ee-8233-d4bd997add9c
...
# ╔═╡ 84832144-f05c-4835-91ab-588de29deab5
function kymograph(p; xticks, yticks, zticks)
	colormap = :gnuplot2
...
# ╔═╡ 9ae691e9-d595-4216-a89d-5c013e4086b2
begin
# Domain length.
L = 2.5u"m"
...
# Position of peak.
xᵤ = (humpstart = 0.5u"m", humpend = 1.0u"m")

# Initialization function. 
init(x, u) = let
	hump = (xᵤ.humpstart .< x) .& (x .< xᵤ.humpend)
	u[:]    .= u₀ / 2.0
	u[hump] .= u₀
end
...
# ╔═╡ 59db7696-7263-47c3-bb94-1cf29d987a49
...
# ╔═╡ 501bf755-8df1-40f7-9e8e-8bc11d7d3606
...
# ╔═╡ 58f8f634-a003-403d-a9bc-f0abfe40c1fb
...
# ╔═╡ 20200c07-6009-4551-9652-773bb5aa6cba
...
# ╔═╡ f91f73ce-a211-4351-89e8-065341258098
p1 = let
	nₓ = 101
	nₜ = 101
	LinearAdvection1D(L, T, c, nₓ, nₜ; init)
end;

# ╔═╡ bfc4b9e9-0c48-4b4f-97a8-26c04e6b4539
plotstate(p1)

# ╔═╡ 0bf0b957-80f3-439b-8869-9d6acf960856
kymograph(p1; xticks = 0.0:0.5:ustrip(L),
		      yticks = 0.0:0.2:ustrip(T),
		      zticks = 0.5:0.1:1.0)

# ╔═╡ 3dd11af2-e7a8-4753-b1da-f5f647e833cb
...
# ╔═╡ 7e5b0b5e-1e69-4244-be99-630ef0cb3039
p2 = let
	nₓ = 101
	nₜ = 101
	NonlinearAdvection1D(L, T, nₓ, nₜ; init)
end;

# ╔═╡ ae254af6-4506-4017-8798-78a163dc3bdf
plotstate(p2)

# ╔═╡ 6fd55b76-dfd1-4b9e-a795-2a6cbe86d35f
kymograph(p2; xticks = 0.0:0.5:ustrip(L),
		      yticks = 0.0:0.2:ustrip(T),
		      zticks = 0.5:0.1:1.0)
...
julia_version = "1.9.3"
manifest_format = "2.0"
project_hash = "a6a43efd6a576b5aa1f6a6fadb495b4dd373ae7b"
