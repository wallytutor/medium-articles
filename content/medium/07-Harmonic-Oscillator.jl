...
# ╔═╡ 8d5237b0-bccc-11ee-16c7-fbdccf016f16
begin
...
# ╔═╡ 13f9183f-bbea-4b35-ba58-7d9794103d05
md"""
...
# ╔═╡ eb360790-e2a8-411f-8d5f-4ec54eb23207
...
# ╔═╡ 7e3c331a-6ef5-4ad3-b641-72baa5aea3a1
md"""
...
# ╔═╡ 73919493-5b13-4046-a38f-6890ed4207f4
begin
	L = 30
...
# ╔═╡ b1032135-f911-4c89-aeb3-5701ac9c0372
md"""
...
# ╔═╡ 541cbb54-0950-4b44-b63a-f9e1181f38c2
begin
	x0 = 0.0;
...
# ╔═╡ be611871-ea10-452a-b8fc-e4bdd56f79c0
md"""
...
# ╔═╡ 421f1e33-07d7-457f-9edc-c89e16d9e5fd
begin
	tspan = (0.0, 20.0);
	pars = (k, V);
...
# ╔═╡ 61c863e0-43f5-4ae8-96dc-1c755b4ef15c
md"""
...
# ╔═╡ ac386256-4cdb-40c3-af68-37af5a0443ad
begin
	nt = length(sol.t);
	usol = zeros(nt, nx);
...
# ╔═╡ fd4a41a0-5f04-46dc-9d01-e8f1a0bdd0a3
md"""
Finally two alternative visualizations of the dynamics are displayed.
"""

# ╔═╡ 0f9d971e-7e14-4de2-9991-213b3ee033e7
# l = @layout [a b]
...
# ╔═╡ ade9ebb1-0ab4-4bc1-8d5c-134073a1459f
md"""
...
# ╔═╡ c3b41b1c-a032-4048-ac67-559104401c40
begin
	Ustar = -U[:, 1:3];
...
# ╔═╡ 47666328-233b-45bb-a76d-62760a1687bb
md"""
...
git-tree-sha1 = "16101db396971a7d64bae230c2b36a04d5f46aa4"
